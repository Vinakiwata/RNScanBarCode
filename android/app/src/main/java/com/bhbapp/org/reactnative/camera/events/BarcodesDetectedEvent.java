...
public class BarcodesDetectedEvent extends Event<BarcodesDetectedEvent> {
  ...
  public static com.bhbapp.org.reactnative.camera.events.BarcodesDetectedEvent obtain(
          int viewTag,
          WritableArray barcodes,
          byte[] compressedImage) {
    com.bhbapp.org.reactnative.camera.events.BarcodesDetectedEvent event = EVENTS_POOL.acquire();
    if (event == null) {
      event = new com.bhbapp.org.reactnative.camera.events.BarcodesDetectedEvent();
    }
