...
import com.bhbapp.org.reactnative.camera.events.*;
...
//  }
  ...
  private static boolean rotationIsLandscape(int rotation) {
    return (rotation == com.bhbapp.org.reactnative.camera.Constants.LANDSCAPE_90 ||
            rotation == com.bhbapp.org.reactnative.camera.Constants.LANDSCAPE_270);
  }
