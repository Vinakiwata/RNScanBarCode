...
public class TouchEvent extends Event<TouchEvent> {
  ...
  public static com.bhbapp.org.reactnative.camera.events.TouchEvent obtain(int viewTag, boolean isDoubleTap, int x, int y) {
    com.bhbapp.org.reactnative.camera.events.TouchEvent event = EVENTS_POOL.acquire();
    if (event == null) {
      event = new com.bhbapp.org.reactnative.camera.events.TouchEvent();
    }
