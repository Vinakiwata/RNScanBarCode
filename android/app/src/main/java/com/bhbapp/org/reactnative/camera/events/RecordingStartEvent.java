...
public class RecordingStartEvent extends Event<RecordingStartEvent> {
    ...
    public static com.bhbapp.org.reactnative.camera.events.RecordingStartEvent obtain(int viewTag, WritableMap response) {
        com.bhbapp.org.reactnative.camera.events.RecordingStartEvent event = EVENTS_POOL.acquire();
        if (event == null) {
        event = new com.bhbapp.org.reactnative.camera.events.RecordingStartEvent();
        }
