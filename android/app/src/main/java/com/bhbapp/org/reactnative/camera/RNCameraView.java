package com.bhbapp.org.reactnative.camera;
...
import com.bhbapp.com.google.android.cameraview.CameraView;
...
import com.bhbapp.org.reactnative.camera.tasks.*;
import com.bhbapp.org.reactnative.camera.utils.RNFileUtils;
//import com.bhbapp.RNCameraModule.facedetector.RNFaceDetector;
import com.bhbapp.RNCameraModule.camera.tasks.*;
  ...
  public RNCameraView(ThemedReactContext themedReactContext) {
    ...
    addCallback(new Callback() {
      ...
      public void onCameraOpened(CameraView cameraView) {
        com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitCameraReadyEvent(cameraView);
      }

      @Override
      public void onMountError(CameraView cameraView) {
        com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitMountErrorEvent(cameraView, "Camera view threw an error - component could not be rendered.");
      }
      ...
      public void onPictureTaken(CameraView cameraView, final byte[] data, int deviceOrientation) {
        ...
        if(Build.VERSION.SDK_INT >= 11/*HONEYCOMB*/) {
          new ResolveTakenPictureAsyncTask(data, promise, options, cacheDirectory, deviceOrientation, com.bhbapp.org.reactnative.camera.RNCameraView.this)
                  .executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        } else {
          new ResolveTakenPictureAsyncTask(data, promise, options, cacheDirectory, deviceOrientation, com.bhbapp.org.reactnative.camera.RNCameraView.this)
                  .execute();
        }
        com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitPictureTakenEvent(cameraView);
      }
      ...
      public void onRecordingStart(CameraView cameraView, String path, int videoOrientation, int deviceOrientation) {
        ...
        com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitRecordingStartEvent(cameraView, result);
      }

      @Override
      public void onRecordingEnd(CameraView cameraView) {
        com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitRecordingEndEvent(cameraView);
      }
      ...
      public void onFramePreview(CameraView cameraView, byte[] data, int width, int height, int rotation) {
        int correctRotation = com.bhbapp.org.reactnative.camera.RNCameraViewHelper.getCorrectCameraRotation(rotation, getFacing(), getCameraOrientation());
...
//        }
  ...
  public void takePicture(final ReadableMap options, final Promise promise, final File cacheDirectory) {
    mBgHandler.post(new Runnable() {
      ...
      public void run() {
        ...
        try {
          com.bhbapp.org.reactnative.camera.RNCameraView.super.takePicture(options);
        } catch (Exception e) {
  ...
  public void onPictureSaved(WritableMap response) {
    com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitPictureSavedEvent(this, response);
  }
      ...
      public void run() {
        try {
          ...
          if (options.hasKey("quality")) {
            profile = com.bhbapp.org.reactnative.camera.RNCameraViewHelper.getCamcorderProfile(options.getInt("quality"));
          }
          ...
          int orientation = com.bhbapp.org.reactnative.camera.Constants.ORIENTATION_AUTO;
          if (options.hasKey("orientation")) {
            orientation = options.getInt("orientation");
          }

          if (com.bhbapp.org.reactnative.camera.RNCameraView.super.record(path, maxDuration * 1000, maxFileSize, recordAudio, profile, orientation, fps)) {
            mIsRecording = true;
  ...
  public void onBarCodeRead(Result barCode, int width, int height, byte[] imageData) {
    ...
    com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitBarCodeReadEvent(this, barCode, width, height, compressedImage);
  }
...
//    }
//
//    com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitFacesDetectedEvent(this, data);
//  }
...
//    }
//
//    com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitFaceDetectionErrorEvent(this, faceDetector);
//  }
...
//  }
  ...
  public void onBarcodesDetected(WritableArray barcodesDetected, int width, int height, byte[] imageData) {
    ...
    com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitBarcodesDetectedEvent(this, barcodesDetected, compressedImage);
  }
  ...
  public void onBarcodeDetectionError(RNBarcodeDetector barcodeDetector) {
    ...
    com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitBarcodeDetectionErrorEvent(this, barcodeDetector);
  }
  ...
  * End Text Recognition */
  ...
  public void onHostResume() {
    if (hasCameraPermissions()) {
      ...
      com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitMountErrorEvent(this, "Camera permissions not granted - component could not be rendered.");
    }
  }
...
//    }
  ...
  private GestureDetector.SimpleOnGestureListener onGestureListener = new GestureDetector.SimpleOnGestureListener(){
    ...
    public boolean onSingleTapUp(MotionEvent e) {
      com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitTouchEvent(com.bhbapp.org.reactnative.camera.RNCameraView.this,false,scalePosition(e.getX()),scalePosition(e.getY()));
      return true;
    }

    @Override
    public boolean onDoubleTap(MotionEvent e) {
      com.bhbapp.org.reactnative.camera.RNCameraViewHelper.emitTouchEvent(com.bhbapp.org.reactnative.camera.RNCameraView.this,true,scalePosition(e.getX()),scalePosition(e.getY()));
      return true;
    }
  };
