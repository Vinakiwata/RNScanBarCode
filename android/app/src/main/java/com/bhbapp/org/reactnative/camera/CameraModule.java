...
import com.bhbapp.com.google.android.cameraview.AspectRatio;
import com.bhbapp.com.google.android.cameraview.Size;
import com.google.zxing.BarcodeFormat;

import com.bhbapp.RNCameraModule.barcodedetector.BarcodeFormatUtils;
import com.bhbapp.org.reactnative.camera.utils.ScopedContext;
...
public class CameraModule extends ReactContextBaseJavaModule {
    ...
    return Collections.unmodifiableMap(new HashMap<String, Object>() {
      {
        ...
        put("Orientation", Collections.unmodifiableMap(new HashMap<String, Object>() {
            {
              put("auto", com.bhbapp.org.reactnative.camera.Constants.ORIENTATION_AUTO);
              put("portrait", com.bhbapp.org.reactnative.camera.Constants.ORIENTATION_UP);
              put("portraitUpsideDown", com.bhbapp.org.reactnative.camera.Constants.ORIENTATION_DOWN);
              put("landscapeLeft", com.bhbapp.org.reactnative.camera.Constants.ORIENTATION_LEFT);
              put("landscapeRight", com.bhbapp.org.reactnative.camera.Constants.ORIENTATION_RIGHT);
            }
        }));
      }
      ...
      private Map<String, Object> getTypeConstants() {
        return Collections.unmodifiableMap(new HashMap<String, Object>() {
          {
            put("front", com.bhbapp.org.reactnative.camera.Constants.FACING_FRONT);
            put("back", com.bhbapp.org.reactnative.camera.Constants.FACING_BACK);
          }
        });
      }
      ...
      private Map<String, Object> getFlashModeConstants() {
        return Collections.unmodifiableMap(new HashMap<String, Object>() {
          {
            put("off", com.bhbapp.org.reactnative.camera.Constants.FLASH_OFF);
            put("on", com.bhbapp.org.reactnative.camera.Constants.FLASH_ON);
            put("auto", com.bhbapp.org.reactnative.camera.Constants.FLASH_AUTO);
            put("torch", com.bhbapp.org.reactnative.camera.Constants.FLASH_TORCH);
          }
        });
      }
      ...
      private Map<String, Object> getWhiteBalanceConstants() {
        return Collections.unmodifiableMap(new HashMap<String, Object>() {
          {
            put("auto", com.bhbapp.org.reactnative.camera.Constants.WB_AUTO);
            put("cloudy", com.bhbapp.org.reactnative.camera.Constants.WB_CLOUDY);
            put("sunny", com.bhbapp.org.reactnative.camera.Constants.WB_SUNNY);
            put("shadow", com.bhbapp.org.reactnative.camera.Constants.WB_SHADOW);
            put("fluorescent", com.bhbapp.org.reactnative.camera.Constants.WB_FLUORESCENT);
            put("incandescent", com.bhbapp.org.reactnative.camera.Constants.WB_INCANDESCENT);
          }
        });
      }
    ...
    public void pausePreview(final int viewTag) {
        ...
        uiManager.addUIBlock(new UIBlock() {
            ...
            public void execute(NativeViewHierarchyManager nativeViewHierarchyManager) {
                final com.bhbapp.org.reactnative.camera.RNCameraView cameraView;

                try {
                    cameraView = (com.bhbapp.org.reactnative.camera.RNCameraView) nativeViewHierarchyManager.resolveView(viewTag);
  ...
  public void takePicture(final ReadableMap options, final int viewTag, final Promise promise) {
    ...
    uiManager.addUIBlock(new UIBlock() {
      @Override
      public void execute(NativeViewHierarchyManager nativeViewHierarchyManager) {
          com.bhbapp.org.reactnative.camera.RNCameraView cameraView = (com.bhbapp.org.reactnative.camera.RNCameraView) nativeViewHierarchyManager.resolveView(viewTag);
          try {
              if (cameraView.isCameraOpened()) {
