package com.bhbapp.RNCameraModule.camera.tasks;

import android.graphics.Rect;
import android.util.SparseArray;

import com.bhbapp.org.reactnative.camera.tasks.BarcodeDetectorAsyncTaskDelegate;
import com.facebook.react.bridge.Arguments;
import com.facebook.react.bridge.WritableArray;
import com.facebook.react.bridge.WritableMap;
import com.google.android.gms.vision.barcode.Barcode;
import com.bhbapp.org.reactnative.camera.utils.ImageDimensions;
import com.bhbapp.org.reactnative.frame.RNFrame;
import com.bhbapp.org.reactnative.frame.RNFrameFactory;
...
public class BarcodeDetectorAsyncTask extends android.os.AsyncTask<Void, Void, SparseArray<Barcode>> {
  ...
  private com.bhbapp.RNCameraModule.barcodedetector.RNBarcodeDetector mBarcodeDetector;
  ...
  public BarcodeDetectorAsyncTask(
          ...
          com.bhbapp.RNCameraModule.barcodedetector.RNBarcodeDetector barcodeDetector,
          byte[] imageData,
          int width,
          int height,
          int rotation,
  ...
  private WritableArray serializeEventData(SparseArray<Barcode> barcodes) {
    ...
    for (int i = 0; i < barcodes.size(); i++) {
      ...
      serializedBarcode.putString("type", com.bhbapp.RNCameraModule.barcodedetector.BarcodeFormatUtils.get(barcode.format));
